		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Pengguna</h2>
					</div>
					<!-- End Box Head -->	
                                        <?php echo form_open('pengguna/search');?>
                                        <br/>
                                        Judul Buku <?php echo form_input('judul_buku');
                                        ...
                                        <table border="1">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url(); ?>index.php/pengguna/pinjam/<?php echo $row->id_buku; ?>/<?php echo $judul_buku; ?>"><span>Pinjam</span></a></td>
                                            </tr>
                                            <?$no++;}?>
                                        </table>
                                        <?php } ?>
